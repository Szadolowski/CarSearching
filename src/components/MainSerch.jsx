...
let SimpleSearch = ({ setChange }) => {
  return (
    <motion.div layout layoutId="search" className=" flex justify-center items-center pt-5" id="search">
      <div className="bg-gray-50 rounded-2xl shadow-2xl border-black p-12 grid grid-cols-4 grid-rows-3 gap-x-4 gap-y-8 place-items-center">
        <DivSearch insideText={"Marka Samochodu"} size={2} marki={marki} simpleSearchInputs={simpleSearchInputs} />
        ...
        <button className="col-span-2 w-full h-full bg-red-700 text-amber-50 font-bold rounded-xl">Szukaj</button>
      </div>
    </motion.div>
  );
};
  ...
  return (
    <motion.div layout layoutId="search" className=" flex justify-center items-center pt-5" id="search">
      <div className="bg-gray-50 rounded-2xl shadow-2xl border-black p-12 grid grid-cols-6 grid-rows-5 gap-x-4 gap-y-8 place-items-center">
        ...
        <span className="col-span-2 cursor-pointer hover:font-bold flex justify-between items-center w-full px-10" onClick={() => {}}>
...
function MainSerch() {
  ...
  return <>{advanceMode ? <AdvanceSearch setChange={setAdvanceMode} /> : <SimpleSearch setChange={setAdvanceMode} />}</>;
}
